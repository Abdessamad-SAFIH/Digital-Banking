package org.enset.ebankigbackend.web;

import org.enset.ebankigbackend.dtos.*;
import org.enset.ebankigbackend.entities.AccountOperation;
...
public class BankAccountRestAPI {
    ...
    public BankAccountDTO getBankAcount(@PathVariable String accountId) throws BankAccountNotFoundException {
    ...
    public List<BankAccountDTO> getBankAccountsCustomer(@PathVariable Long customerId){
